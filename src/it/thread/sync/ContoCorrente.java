...
public class ContoCorrente {
    ...
    public double getSaldo() {
        ...
        try {
            //File fin = new File(new File(".").getCanonicalPath() + File.pathSeparator + "db.txt");
            File fin = new File("C:\\Users\\simone.berti\\eclipse-workspace\\CorsoJava\\src\\it\\thread\\sync\\db.txt");
    ...
    public synchronized void prelievo(double somma) throws Exception {
        ...
        try {
            ...
            if (nuovoSaldo > 0) {
                //fw = new FileWriter(new File(".").getCanonicalPath() + File.pathSeparator + "db.txt");
                fw = new FileWriter(new File("C:\\Users\\simone.berti\\eclipse-workspace\\CorsoJava\\src\\it\\thread\\sync\\db.txt"));
